  ...
  return (
    ...
    <style dangerouslySetInnerHTML={{ __html: `
      ...
      @media print {
        ...
        body { background: white !important; font-family: 'Inter', sans-serif !important; color: black !important; font-size: 12pt !important; line-height: 1.5 !important; }
        @page { margin: 2cm; }
        h1 { font-size: 24pt !important; margin-bottom: 2rem !important; border-bottom: 2px solid black !important; padding-bottom: 0.5rem !important; }
        h2 { font-size: 16pt !important; margin-top: 2rem !important; margin-bottom: 1rem !important; text-transform: uppercase !important; }
        .footer { position: fixed; bottom: 0; width: 100%; text-align: center; font-size: 10pt !important; color: #666 !important; border-top: 1px solid #ccc !important; padding-top: 1rem !important; }
      }
    `}} />

    {/* Dedicated Print Template */}
    <div className="print-only">
      <h1>CivilEase — Official Document Analysis</h1>
      ...
      <section>
        ...
        <ol style={{ listStyleType: 'decimal', paddingLeft: '2rem' }}>
          {result.procedural_requirements?.verification_steps?.map((step, i) => (
      ...
      <section>
        ...
        <ul style={{ listStyleType: 'disc', paddingLeft: '2rem' }}>
          {result.procedural_requirements?.mandatory_documents?.map((doc, i) => (
      ...
      <section>
        ...
        <p><strong>{result.document_identity?.issuing_authority}</strong></p>
        <p>{result.document_identity?.department}</p>
      </section>

      <div className="footer">
        Generated by CivilEase | civilease.in
      </div>
    </div>
